...
2.  Define a gene set. **Define differential expressed genes in receiver cells potentially affected by ligands** (*Most challenging*)
...
Expression data of interacting cells: publicly available single-cell data from CAF and malignant cells from head and neck squamous cell carcinoma (HNSCC) tumors:

A subset of malignant cells expressing partial epithelial-to-mesenchymal transition (p-EMT) program interacts with cancer associated fibroblasts (CAFs).
